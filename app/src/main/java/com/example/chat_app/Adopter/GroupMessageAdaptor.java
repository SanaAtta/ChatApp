...
public class GroupMessageAdaptor extends RecyclerView.Adapter<GroupMessageAdaptor.GroupMessagesViewHolder >
{
    ...
    public GroupMessageAdaptor (List<Messages> userGroupMessagesList)
    {
    ...
    @NotNull
    @Override
    public GroupMessagesViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull GroupMessageAdaptor.GroupMessagesViewHolder holder, int position) {
...
//                });
    ...
    public  class GroupMessagesViewHolder extends RecyclerView.ViewHolder {
        ...
        public GroupMessagesViewHolder(@NonNull @NotNull View itemView) {
            super(itemView);
    ...
    private  void  deleteSentMessages( final  int postion, final @NotNull GroupMessagesViewHolder messageViewHolder)
    {
    ...
    private  void  deleteReceivedMessages( final  int postion, final @NotNull GroupMessagesViewHolder messageViewHolder)
    {
        DatabaseReference rootRef =FirebaseDatabase.getInstance().getReference();
        rootRef.child("Messages")
                .child(userMessagesList.get(postion).getTo())
    ...
    private  void  deleteMessagesFromEveryOne( final  int postion, final @NotNull GroupMessagesViewHolder messageViewHolder)
    {
        DatabaseReference rootRef =FirebaseDatabase.getInstance().getReference();
        rootRef.child("Messages")
                .child(userMessagesList.get(postion).getTo())
