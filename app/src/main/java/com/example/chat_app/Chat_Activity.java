...
import com.example.chat_app.Adopter.MessageAdapter;
...
public class  Chat_Activity extends AppCompatActivity {
    ...
    private ImageButton SendMessageButton, SendFilesButton, SendCameraImageButton, sendCallButton;
...
//        setSupportActionBar(ChatToolBar);
        ...
        SendCameraImageButton =  (ImageButton) findViewById(R.id.send_Camera_Image_btn);
                        ...
                        if (task.isSuccessful())
                        {
                            ...
                            RootRef.updateChildren(messageBodyDetails).addOnCompleteListener(new OnCompleteListener() {
                                ...
                                public void onComplete(@NonNull Task task)
                                {
                                    ...
                                    {
                                        loadingBar.dismiss();
                                        Toast.makeText(Chat_Activity.this, "Image Sent Successfully...", Toast.LENGTH_SHORT).show();
                                    }
                                    else
                                    {
                                        loadingBar.dismiss();
